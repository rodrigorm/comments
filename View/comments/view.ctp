...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__d('comments', 'Edit Comment'), array('action'=>'edit', $comment['Comment']['id'])); ?> </li>
		<li><?php echo $html->link(__d('comments', 'Delete Comment'), array('action'=>'delete', $comment['Comment']['id']), null, sprintf(__d('comments', 'Are you sure you want to delete # %s?'), $comment['Comment']['id'])); ?> </li>
		<li><?php echo $html->link(__d('comments', 'List Comments'), array('action'=>'index')); ?> </li>
		<li><?php echo $html->link(__d('comments', 'New Comment'), array('action'=>'add')); ?> </li>
		<li><?php echo $html->link(__d('comments', 'List Comments'), array('controller'=> 'comments', 'action'=>'index')); ?> </li>
		<li><?php echo $html->link(__d('comments', 'New Parent Comment'), array('controller'=> 'comments', 'action'=>'add')); ?> </li>
		<li><?php echo $html->link(__d('comments', 'List Users'), array('controller'=> 'users', 'action'=>'index')); ?> </li>
		<li><?php echo $html->link(__d('comments', 'New User'), array('controller'=> 'users', 'action'=>'add')); ?> </li>
	</ul>
</div>
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $html->link(__d('comments', 'View'), array('controller'=> 'comments', 'action'=>'view', $childComment['id'])); ?>
				<?php echo $html->link(__d('comments', 'Edit'), array('controller'=> 'comments', 'action'=>'edit', $childComment['id'])); ?>
				<?php echo $html->link(__d('comments', 'Delete'), array('controller'=> 'comments', 'action'=>'delete', $childComment['id']), null, sprintf(__d('comments', 'Are you sure you want to delete # %s?'), $childComment['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
<?php endif; ?>
	...
	<div class="actions">
		<ul>
			<li><?php echo $html->link(__d('comments', 'New Child Comment'), array('controller'=> 'comments', 'action'=>'add'));?> </li>
		</ul>
	</div>
</div>
