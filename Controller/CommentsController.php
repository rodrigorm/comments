 ...
 * @var array
 */
	public $components = array('RequestHandler', 'Paginator', 'Session', 'Cookie');
 ...
 */
	public function admin_approve($id) {
		...
		if (!$this->Comment->exists(true)) {
			...
			$this->Session->setFlash(__d('comments', 'The comment has been approved'));
		} else {
			$this->Session->setFlash(__d('comments', 'Error appear during save.'));
		}
		$this->redirect(array('action' => 'index'));
 ...
 */
	public function admin_disapprove($id) {
		...
		if (!$this->Comment->exists(true)) {
			...
			$this->Session->setFlash(__d('comments', 'The comment has been disapproved'));
		} else {
			$this->Session->setFlash(__d('comments', 'Error appear during save.'));
		}
		$this->redirect(array('action' => 'index'));
